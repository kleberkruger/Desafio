...
import br.ufms.desafio.controller.ResponsavelService;
...
@Component
public class ResponsaveisResource {
    ...
    public Responsavel get(@PathParam("id") long id) {
        return (Responsavel) service.get(id);
    }

    @POST
    public Response post(Responsavel bean) {
        service.save(bean);
        return Response.Ok("Objeto salvo com sucesso");
    }

    @PUT
    public Response put(Responsavel bean) {
        service.save(bean);
        return Response.Ok("Objeto atualizado com sucesso");
    }

    @DELETE
    public Response delete(Responsavel bean) {
        service.delete(bean);
